...
- (void)addTextureWithImage:(UIImage *)image textureIndex:(NSInteger)textureIndex
{
    ...
    if (redrawNeeded)
    {
        ...
        CGContextRef imageContext = CGBitmapContextCreate(imageData, (size_t)imageSize.width, (size_t)imageSize.height, 8, (size_t)imageSize.width * 4, genericRGBColorspace, kCGBitmapByteOrder32Little | (CGBitmapInfo)kCGImageAlphaPremultipliedFirst);
